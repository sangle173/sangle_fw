...
public class KeyEventUtils {
    ...
    public static void pressChannelUp(AndroidDriver driver) throws InterruptedException {
        pressKey(driver, AndroidKey.MEDIA_NEXT, "Pressing Channel Up Key");
    }

    public static void pressChannelUp(AndroidDriver driver, int times) throws InterruptedException {
    ...
    public static void pressChannelDown(AndroidDriver driver) throws InterruptedException {
        pressKey(driver, AndroidKey.MEDIA_PREVIOUS, "Pressing Channel Down Key");
    }

    public static void pressChannelDown(AndroidDriver driver, int times) throws InterruptedException {
    ...
    private AndroidKey getAndroidKeyForCharacter(char c) {
        switch (c) {
            ...
            case 'z':
                return AndroidKey.Z;
            case '1':
                return AndroidKey.NUMPAD_1;  // KeyEvent.KEYCODE_1 for number 1
            case '2':
                return AndroidKey.NUMPAD_2; // KeyEvent.KEYCODE_2 for number 2
            case '3':
                return AndroidKey.NUMPAD_3;  // KeyEvent.KEYCODE_3 for number 3
            case '4':
                return AndroidKey.NUMPAD_4;  // KeyEvent.KEYCODE_4 for number 4
            case '5':
                return AndroidKey.NUMPAD_5;  // KeyEvent.KEYCODE_5 for number 5
            case '6':
                return AndroidKey.NUMPAD_6;  // KeyEvent.KEYCODE_6 for number 6
            case '7':
                return AndroidKey.NUMPAD_7;  // KeyEvent.KEYCODE_7 for number 7
            case '8':
                return AndroidKey.NUMPAD_8;  // KeyEvent.KEYCODE_8 for number 8
            case '9':
                return AndroidKey.NUMPAD_9;  // KeyEvent.KEYCODE_9 for number 9
            case '0':
                return AndroidKey.NUMPAD_0;  // KeyEvent.KEYCODE_0 for number 0
            case ' ':
                return AndroidKey.SPACE;  // Space key
            case '.':
                return AndroidKey.PERIOD; // Period key
            case '@':
                return AndroidKey.AT;     // At key (special character)
            default:
                return null; // Unsupported characters
        }
    }
